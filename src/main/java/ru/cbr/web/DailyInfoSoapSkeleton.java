...
public class DailyInfoSoapSkeleton implements ru.cbr.web.DailyInfoSoap, org.apache.axis.wsdl.Skeleton {
    ...
    */
    ...
    public DailyInfoSoapSkeleton() {
        this.impl = new ru.cbr.web.DailyInfoSoapImpl();
    }

    public DailyInfoSoapSkeleton(ru.cbr.web.DailyInfoSoap impl) {
        this.impl = impl;
    }
