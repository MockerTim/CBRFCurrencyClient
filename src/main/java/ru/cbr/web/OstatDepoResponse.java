...
public class OstatDepoResponse  implements java.io.Serializable {
    private ru.cbr.web.OstatDepoResponseOstatDepoResult ostatDepoResult;

    public OstatDepoResponse() {
    }

    public OstatDepoResponse(
           ru.cbr.web.OstatDepoResponseOstatDepoResult ostatDepoResult) {
     ...
     */
    public ru.cbr.web.OstatDepoResponseOstatDepoResult getOstatDepoResult() {
        return ostatDepoResult;
    }
     ...
     */
    public void setOstatDepoResult(ru.cbr.web.OstatDepoResponseOstatDepoResult ostatDepoResult) {
        this.ostatDepoResult = ostatDepoResult;
    }
