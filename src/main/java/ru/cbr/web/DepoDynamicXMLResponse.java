...
public class DepoDynamicXMLResponse  implements java.io.Serializable {
    private ru.cbr.web.DepoDynamicXMLResponseDepoDynamicXMLResult depoDynamicXMLResult;

    public DepoDynamicXMLResponse() {
    }

    public DepoDynamicXMLResponse(
           ru.cbr.web.DepoDynamicXMLResponseDepoDynamicXMLResult depoDynamicXMLResult) {
     ...
     */
    public ru.cbr.web.DepoDynamicXMLResponseDepoDynamicXMLResult getDepoDynamicXMLResult() {
        return depoDynamicXMLResult;
    }
     ...
     */
    public void setDepoDynamicXMLResult(ru.cbr.web.DepoDynamicXMLResponseDepoDynamicXMLResult depoDynamicXMLResult) {
        this.depoDynamicXMLResult = depoDynamicXMLResult;
    }
