...
public class DVXMLResponse  implements java.io.Serializable {
    private ru.cbr.web.DVXMLResponseDVXMLResult DVXMLResult;

    public DVXMLResponse() {
    }

    public DVXMLResponse(
           ru.cbr.web.DVXMLResponseDVXMLResult DVXMLResult) {
     ...
     * @return DVXMLResult
     */
    public ru.cbr.web.DVXMLResponseDVXMLResult getDVXMLResult() {
        return DVXMLResult;
    }
     ...
     * @param DVXMLResult
     */
    public void setDVXMLResult(ru.cbr.web.DVXMLResponseDVXMLResult DVXMLResult) {
        this.DVXMLResult = DVXMLResult;
    }
