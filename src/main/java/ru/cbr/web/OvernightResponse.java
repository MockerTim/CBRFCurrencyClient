...
public class OvernightResponse  implements java.io.Serializable {
    private ru.cbr.web.OvernightResponseOvernightResult overnightResult;

    public OvernightResponse() {
    }

    public OvernightResponse(
           ru.cbr.web.OvernightResponseOvernightResult overnightResult) {
     ...
     */
    public ru.cbr.web.OvernightResponseOvernightResult getOvernightResult() {
        return overnightResult;
    }
     ...
     */
    public void setOvernightResult(ru.cbr.web.OvernightResponseOvernightResult overnightResult) {
        this.overnightResult = overnightResult;
    }
