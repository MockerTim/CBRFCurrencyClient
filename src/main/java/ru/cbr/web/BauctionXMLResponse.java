...
public class BauctionXMLResponse  implements java.io.Serializable {
    private ru.cbr.web.BauctionXMLResponseBauctionXMLResult bauctionXMLResult;

    public BauctionXMLResponse() {
    }

    public BauctionXMLResponse(
           ru.cbr.web.BauctionXMLResponseBauctionXMLResult bauctionXMLResult) {
     ...
     */
    public ru.cbr.web.BauctionXMLResponseBauctionXMLResult getBauctionXMLResult() {
        return bauctionXMLResult;
    }
     ...
     */
    public void setBauctionXMLResult(ru.cbr.web.BauctionXMLResponseBauctionXMLResult bauctionXMLResult) {
        this.bauctionXMLResult = bauctionXMLResult;
    }
