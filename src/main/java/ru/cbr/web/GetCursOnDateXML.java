...
public class GetCursOnDateXML  implements java.io.Serializable {
    ...
    /**
     * Gets the on_date value for this GetCursOnDateXML.
     * 
     * @return on_date
     */
    ...
    /**
     * Sets the on_date value for this GetCursOnDateXML.
     * 
     * @param on_date
     */
    ...
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof GetCursOnDateXML)) return false;
        GetCursOnDateXML other = (GetCursOnDateXML) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(GetCursOnDateXML.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://web.cbr.ru/", ">GetCursOnDateXML"));
